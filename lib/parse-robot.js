 ...
 *      ],
 *      "keywords": [
 *          {name: '', documentation: '', arguments: ['', '', ...], lineNo: 0, colNo: 0},
 *          ...
 *      ],
...
var parse = function(fileContentOrig) {
    ...
    fileContent = fileContentOrig.replace(tabRegexp, '  ');
    ...
    fillLineNumbers(fileContentOrig, keywords);
    return {
        keywords: keywords,
        testCases: testCases,
